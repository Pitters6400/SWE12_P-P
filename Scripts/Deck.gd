...
func _ready() -> void:
	# Use the global starting deck
	player_deck = Global.starting_deck.duplicate()
	player_deck.shuffle()
...
func draw_card():
	...
	# Hide the deck when it runs out
	...
	var card_image_path = "res://Assets/" + card_drawn_name + ".png"
